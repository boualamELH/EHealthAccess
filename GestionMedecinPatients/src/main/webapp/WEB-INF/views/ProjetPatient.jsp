            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<%=request.getContextPath()%>/resources/images/Patienticon.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Name of Doctor</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<%=request.getContextPath()%>/resources/images/Patienticon.jpg" class="img-circle" alt="User Image">
                    <p>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Consultation du dossier</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
            ...
            <li class="treeview">
              <a onclick="printinfo('classpat1')" href="GestionPatient">

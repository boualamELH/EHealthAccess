...
<div   class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="${med.getCode_medecin()}del">
  ...
  <f:form class="btn" modelAttribute="GestionForme" method="post" action="ManagementMedecinsprive">
        ...
        <section class="content">
          ...
          <div class="row">
              <div class="box box-warning">
                ...
                <div class="box-body">
          <f:form class="fiel" modelAttribute="GestionForme" method="post" action="ManagementMedecinsprive">
                    <!-- text input -->
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="designation" rows="3" placeholder="Désignation">${med.getNom_clinique()}</textarea>
                    </div>
                       
                    <div class="form-group">
                      <label>Adresse clinique</label>
                      <textarea class="form-control" name="description" rows="3" placeholder="Description" >${med.getAdresse_clinique()}</textarea>
                    </div>

                    
                     <div class="send">
		             <form id="saveid"  action="ManagementMedecinsprive" >
	                  <button  class="btn btn-primary btn-lg" name="enregistrer"  type="submit" >Enregistrer</button>
	                  </form>
	                 <form action="/MedecinPatients/ManagementMedecinsprive" id="annulerid">
